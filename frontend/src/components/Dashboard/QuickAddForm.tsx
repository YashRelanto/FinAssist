  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok || data.success) {
        ...
        const accountName =
          accounts?.find((acc) => acc.account_id === formData.accountId)?.account_name ??
          'Unknown Account';
    ...
    <div className="flex flex-col h-full">
      <div className="mb-6 border-b border-outline-variant/20 pb-3 space-y-3">
        <div className="flex items-center justify-between gap-3">
          <h3 className="text-lg font-black uppercase tracking-widest text-on-surface">
            Quick Add
          </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex-1 flex flex-col">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-1.5">
              <label className="text-[9px] font-black text-outline uppercase tracking-[0.2em] ml-1">
                Amount
              </label>
              <input
                required
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({ ...formData, mainCategory: e.target.value, subCategory: 'General' })
                }
            ...
            {formData.isRecurring && (
              <div className="grid grid-cols-2 gap-4 pt-1 animate-in fade-in slide-in-from-top-1 duration-200">
                <div className="space-y-1">
                  <label className="text-[8px] font-black text-outline uppercase tracking-[0.2em] ml-0.5">
                    Period
                  </label>
                  <select
                    value={formData.recurrencePeriod}
                    onChange={(e) =>
                      setFormData({ ...formData, recurrencePeriod: e.target.value })
                    }
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, recurrenceSkips: e.target.value })
                    }
        ...
        <div className="flex-1 flex flex-col overflow-y-auto space-y-3 pb-2 scrollbar-hide max-h-[360px]">
          {loadingUpcoming ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center py-20 px-4">
              ...
              <p className="text-xs font-black text-outline uppercase tracking-wider">
                No upcoming payments
              </p>
              <p className="text-[10px] text-outline/60 mt-1">
                Add a recurring transaction to schedule payments.
              </p>
            </div>
          ) : (
              ...
              >
                <div className="space-y-1">
                  ...
                  <div className="flex flex-wrap gap-2 items-center text-[9px] font-black uppercase tracking-wider text-outline">
                    <span className="bg-surface-container-lowest px-2 py-0.5 rounded border border-outline-variant/10">
                      {payment.category}
                    </span>
                    <span>•</span>
