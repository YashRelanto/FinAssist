#!/usr/bin/env python3
"""
Nightly cron entrypoint: train global Prophet model from Supabase into staging.

Production promotion is done separately via Admin → Deploy to Production.
...
from app.services.prophet.training import run_training_pipeline  # noqa: E402
...
def main() -> int:
    try:
        ...
        print(
            ...
            f"staging={result.get('staging_path')}",
        )
        return 0
